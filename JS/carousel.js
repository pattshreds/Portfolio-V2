...
for (const btn of prevBtns) {
    btn.addEventListener('click', e => {
        const imageList = e.target.parentElement.parentElement.querySelector('.images-list');
        const currentSlide = imageList.querySelector('.current-slide');
        const currentDot = e.target.parentElement.parentElement.querySelector('.current-dot');
...
for (const dot of nav) {
    dot.addEventListener('click', e => {
        const imageList = e.target.parentElement.parentElement.querySelector('.images-list');
        const navDots = e.target.parentElement.parentElement.querySelector('.carousel-nav');
